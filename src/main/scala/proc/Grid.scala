...
class Grid(val m: AntSim, var width: Int, var height: Int){
    ...
    val antCount: Int = Config.antCount
    ...
    populateGridBy(CellType.food, Direction.DR, 3000)
    ...
    def populateGridBy(cellType: CellType, where: Direction.Direction, n: Int): Unit = {
